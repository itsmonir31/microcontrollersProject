...
@torch.no_grad()
def run(
        weights=ROOT / 'train_model.pt',  # model.pt path(s)
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    #kl = s[:-2] + ' '
                    #ki = "'0: 480x640 1 30, '"
                    # extract 30  from '0: 480x640 1 30, '
                    kl = s[:-2].split(' ')[3][:-1]
                    speed = 10
